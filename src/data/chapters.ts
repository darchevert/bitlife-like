        ...
        choices: [
          {
            ...
            npcReaction:
              '« Parce que voilà. » Le couloir entier a suivi la scène en direct — et en story, 200 vues avant la fin de la journée.',
            effects: { bonheur: -6, reputation: -3 },
            memoryTags: ['premier-chagrin-public'],
          },
          {
            id: 'faire-style',
            label: 'Encaisser, l’air de rien',
            emoji: '😐',
            isReply: true,
            resultText: '« Ok. Cool. Tout va bien. »',
            npcReaction: '« Cool aussi, alors. » Et plus rien. Personne n’est dupe, surtout pas {name}.',
            effects: { bonheur: -4 },
        ...
        choices: [
          {
            ...
            npcReaction: 'Le recruteur note quelque chose. Le silence qui suit dure exactement assez longtemps pour être gênant.',
          ...
          },
          {
            ...
            emoji: '🙋',
            isReply: true,
            resultText: '« Une fois, j’ai fait perdre trois semaines à toute une équipe. On en rit encore. Enfin... eux, surtout. »',
            npcReaction: 'Le recruteur sourit, écrit « sincère » — juste au-dessus de « embauche quelqu’un d’autre ».',
            effects: { bonheur: -3 },
          },
        ],
      },
        ...
        choices: [
          {
            ...
            npcReaction: 'Le patron hausse un sourcil, puis repart sans un mot. Ambiance un peu étrange au bureau pendant une semaine.',
          ...
          },
          {
            ...
            npcReaction: 'Kevin n’a jamais travaillé un mercredi. Les caméras, elles, travaillent tous les jours.',
